...
AmCharts.wrappedText = function(a, b, c, d, f, e, g, h, k) {
	...
	if(l) {
		...
		if(n.width > h) {
			...
			for(var q, r = 0; r < l.length; r += Math.ceil(l.length / n)) q = l[r], b = b.substr(0, q) + m + b.substr(q + 1);
			if(isNaN(q)) {
				if(0 == k)
					for(r = 1; r < n; r++) q = Math.round(b.length / n * r), b = b.substr(0, q) + m + b.substr(q);
...
AmCharts.AmChart = AmCharts.Class({
	...
	brr: function() {
		...
		if("amcharts.com" != b || !0 === this.inIframe()) {
			...
			"ammap" == this.product && (e = "http://www.ammap.com/javascript-maps/",
		...
		if(!isNaN(a)) {
			...
			if(this.show) {
				var g = this.l,
					...
					r = this.borderColor,
					q = n;
				void 0 != m && (this.adjustBorderColor ? q = r = m : n = m);
				...
				var p = this.minWidth,
					y = "";
				isNaN(p) || (y = "min-width:" + (p - 2 * x) + "px; ");
				m.innerHTML = '<div style="text-align:' + this.textAlign + "; " + y + "max-width:" + this.maxWidth + "px; font-size:" + t + "px; color:" + this.color + "; font-family:" + w + '">' + this.text + "</div>";
				c.chartDiv.appendChild(m);
				this.textDiv = m;
				t = m.offsetWidth;
				w = m.offsetHeight;
				m.clientHeight && (t = m.clientWidth, w = m.clientHeight);
				w += 2 * z;
				y = t + 2 * x;
				!isNaN(p) && y < p && (y = p);
				window.opera &&
				...
				var C = !1,
					t = this.offsetY;
				c.handDrawn && (t += c.handDrawScatter + 2);
				"H" != B ? (p = a - y / 2, b < h + w + 10 && "down" != B ? (C = !0, d && (b += t), t = b + v, this.deltaSignY = -1) : (d && (b -= t), t = b - w - v, this.deltaSignY = 1)) : (2 * v > w && (v = w / 2), t = b - w / 2, a < g + (k - g) / 2 ? (p = a + v, this.deltaSignX = -1) : (p = a - y - v, this.deltaSignX = 1));
				t + w >= l && (t = l - w);
				t < h && (t = h);
				p < g && (p = g);
				p + y > k && (p = k - y);
				var h = t + z,
					...
					D = this.bulletSize,
					E;
				0 < A || 0 === v ? (0 < z && (a = AmCharts.rect(f, y, w, n, 0, x + 1, F, z, this.cornerRadius), AmCharts.isModern ?
					a.translate(1, 1) : a.translate(4, 4), e.push(a)), n = AmCharts.rect(f, y, w, n, this.fillAlpha, x, r, this.borderAlpha, this.cornerRadius), this.showBullet && (E = AmCharts.circle(f, D, q, this.fillAlpha), e.push(E))) : (q = [], A = [], "H" != B ? (g = a - p, g > y - v && (g = y - v), g < v && (g = v), q = [0, g - v, a - p, g + v, y, y, 0, 0], A = C ? [0, 0, b - t, 0, 0, w, w, 0] : [w, w, b - t, w, w, 0, 0, w]) : (q = b - t, q > w - v && (q = w - v), q < v && (q = v), A = [0, q - v, b - t, q + v, w, w, 0, 0], q = a < g + (k - g) / 2 ? [0, 0, p < a ? 0 : a - p, 0, 0, y, y, 0] : [y, y, p + y > a ? y : a - p, y, y, 0, 0, y]), 0 < z && (a = AmCharts.polygon(f, q, A, n, 0, x, F, z), a.translate(1, 1),
					e.push(a)), n = AmCharts.polygon(f, q, A, n, this.fillAlpha, x, r, this.borderAlpha));
				this.bg = n;
				e.push(n);
				n.toFront();
				...
				this.bottom = t + w + 1;
				this.yPos = n.y + t;
				E && E.translate(this.pointToX - p + f, b - t);
	...
	switch(b) {
		...
		case "xError":
			n = a.set(), n.push(AmCharts.line(a, [-c /
				2, c / 2
			], [0, 0], d, f, e)), n.push(AmCharts.line(a, [-c / 2, -c / 2], [-k, k], d, f, e)), n.push(AmCharts.line(a, [c / 2, c / 2], [-k, k], d, f, e))
	}
	n && n.pattern(m);
	return n
};
...
AmCharts.handDrawnLine = function(a, b, c, d, f, e, g, h, k, l, m) {
	...
	for(m = 1; m < b.length; m++)
		for(var r = [b[m - 1], b[m]], q = [c[m - 1], c[m]], q = AmCharts.makeHD(r, q, a.handDrawScatter), r = q[0], q = q[1], x = 1; x < r.length; x++) n.push(AmCharts.line(a, [r[x - 1], r[x]], [q[x - 1], q[x]], d, f, e + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, g, h, k, l, !0));
	return n
};
...
AmCharts.wedge = function(a, b, c, d, f, e, g, h, k, l, m, n) {
	...
	var v = 1 / 180 * Math.PI,
		...
		A = b + Math.sin(d * v) * e,
		w = c - Math.cos(d * v) * g,
		t = b + Math.sin((d + f) * v) * e,
		u = c - Math.cos((d + f) * v) * g,
		p = b + Math.sin((d + f) * v) * h,
		v = c - Math.cos((d + f) * v) * q,
		y = {
	...
	d = a.set();
	var F;
	x && (z = r(10 * z), A = r(10 * A), t = r(10 * t), p = r(10 * p), B = r(10 * B), w = r(10 * w), u = r(10 * u), v = r(10 * v), b = r(10 * b), k = r(10 * k), c = r(10 * c), e *= 10, g *= 10, h *= 10, q *= 10, 1 > Math.abs(f) && 1 >= Math.abs(t - A) && 1 >= Math.abs(u - w) && (F = !0));
	f = "";
	var D;
	n && (y["fill-opacity"] = 0, y["stroke-opacity"] = l["stroke-opacity"] / 2, y.stroke = l.stroke);
	0 < k && (D = " M" + z + "," + (B + k) + " L" + A + "," + (w + k), x ? (F || (D += " A" + (b - e) + "," + (k + c - g) + "," + (b + e) + "," + (k + c + g) + "," + A + "," + (w + k) + "," + t + "," + (u + k)), D += " L" + p + "," + (v + k), 0 < h && (F || (D += " B" + (b - h) + "," + (k + c - q) + "," + (b + h) + "," + (k + c + q) +
		"," + p + "," + (k + v) + "," + z + "," + (k + B)))) : (D += " A" + e + "," + g + ",0," + C + ",1," + t + "," + (u + k) + " L" + p + "," + (v + k), 0 < h && (D += " A" + h + "," + q + ",0," + C + ",0," + z + "," + (B + k))), D = a.path(D + " Z", void 0, void 0, "1000,1000").attr(y), d.push(D), D = a.path(" M" + z + "," + B + " L" + z + "," + (B + k) + " L" + A + "," + (w + k) + " L" + A + "," + w + " L" + z + "," + B + " Z", void 0, void 0, "1000,1000").attr(y), k = a.path(" M" + t + "," + u + " L" + t + "," + (u + k) + " L" + p + "," + (v + k) + " L" + p + "," + v + " L" + t + "," + u + " Z", void 0, void 0, "1000,1000").attr(y), d.push(D), d.push(k));
	x ? (F || (f = " A" + r(b - e) + "," + r(c - g) +
		"," + r(b + e) + "," + r(c + g) + "," + r(A) + "," + r(w) + "," + r(t) + "," + r(u)), e = " M" + r(z) + "," + r(B) + " L" + r(A) + "," + r(w) + f + " L" + r(p) + "," + r(v)) : e = " M" + z + "," + B + " L" + A + "," + w + (" A" + e + "," + g + ",0," + C + ",1," + t + "," + u) + " L" + p + "," + v;
	0 < h && (x ? F || (e += " B" + (b - h) + "," + (c - q) + "," + (b + h) + "," + (c + q) + "," + p + "," + v + "," + z + "," + B) : e += " A" + h + "," + q + ",0," + C + ",0," + z + "," + B);
	a.handDrawn && (b = AmCharts.line(a, [z, A], [B, w], l.stroke, l.thickness * Math.random() * a.handDrawThickness, l["stroke-opacity"]), d.push(b));
...
AmCharts.AmLegend = AmCharts.Class({
	...
	drawLegend: function() {
		...
		this.titleWidth = 0;
		if(f = this.title) f = AmCharts.text(this.container, f, this.color, a.fontFamily, this.fontSize, "start", !0), AmCharts.setCN(a, f, "legend-title"), f.translate(this.marginLeft,
	...
	arrangeEntries: function() {
		...
		for(w = 0; w < B.length; w++) {
			...
			A = C.getBBox();
			var F;
			this.equalWidths ? F = e + t * (r + m + this.markerLabelGap) : (F = u, u = u + A.width + e + m);
			A.height > y && (y = A.height);
			F + A.width > n && 0 < w && 0 !== t && (q++, t = 0,
				F = e, u = F + A.width + e + m, p = p + y + l, y = 0);
			C.translate(F, p);
			t++;
			!isNaN(k) && t >= k && (t = 0, q++, p = p + y + l, y = 0);
			v.push(C)
		}
		A = v.getBBox();
		k = A.height + 2 * l - 1;
		...
		c.toBack();
		b = e;
		if("top" == a || "bottom" == a || "absolute" == a || "outside" == a) "center" == this.align ? b = e +
			(h - A.width) / 2 : "right" == this.align && (b = e + h - A.width);
		v.translate(b, l + 1);
	...
	createEntry: function(a) {
		if(!1 !== a.visibleInLegend) {
			...
			if(this.useGraphSettings) {
				...
				if("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c) g = k.set(), a.hidden || (d = a.lineColorR, e = a.bulletBorderColorR), m = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength), AmCharts.setCN(b, m, "graph-line"), g.push(m), a.bullet && (a.hidden || (d = a.bulletColorR), m = AmCharts.bullet(k, a.bullet,
					a.bulletSize, d, a.bulletAlpha, a.bulletBorderThickness, e, a.bulletBorderAlpha)) && (AmCharts.setCN(b, m, "graph-bullet"), m.translate(l + 1, l / 2), g.push(m)), r = 0, m = l, n = l / 3;
				else {
					var q;
					a.getGradRotation && (q = a.getGradRotation());
					m = a.fillColorsR;
					!0 === a.hidden && (m = d);
					if(g = this.createMarker("rectangle", m, a.fillAlphas, a.lineThickness, d, a.lineAlpha, q, g)) r = l, g.translate(r, l / 2);
					m = l
				}
				AmCharts.setCN(b, g, "graph-" + c);
				AmCharts.setCN(b, g, "graph-" + a.id)
			} else h ? (b.path && (h = b.path + h), g = k.image(h, 0, 0, l, l)) : (g = this.createMarker(c,
				d, f, void 0, void 0, void 0, void 0, g)) && g.translate(l / 2, l / 2);
			...
			(e = this.switchType) && "none" != e && ("x" == e ? (c = this.createX(), c.translate(l / 2, l / 2)) : c = this.createV(), c.dItem = a, !0 !== a.hidden ? "x" == e ? c.hide() : c.show() : "x" != e && c.hide(), this.switchable || c.hide(), this.addListeners(c, a), a.legendSwitch =
			...
			c = this.fontSize;
			g && (l <= c && g.translate(r, l / 2 + this.ly - c / 2 + (c + 2 - l) / 2 - n), a.legendEntryWidth = g.getBBox().width);
			var x;
			d && (d = AmCharts.fixBrakes(d), a.legendTextReal = d, x = this.labelWidth, x = isNaN(x) ? AmCharts.text(this.container,
				d, e, b.fontFamily, c, "start") : AmCharts.wrappedText(this.container, d, e, b.fontFamily, c, "start", !1, x, 0), AmCharts.setCN(b, x, "legend-label"), x.translate(this.lx + m, this.ly), k.push(x), b = x.getBBox().width, this.maxLabelWidth < b && (this.maxLabelWidth = b));
...
AmCharts.AmMap = AmCharts.Class({
	...
	drawChart: function() {
		...
		this.linesSettings = AmCharts.processObject(this.linesSettings,
			AmCharts.LinesSettings, this.theme);
	...
	buildEverything: function() {
		...
		if(0 < a.realWidth && 0 < a.realHeight) {
			...
			c = a.dataProvider;
			isNaN(c.zoomX) && isNaN(c.zoomY) && isNaN(c.zoomLatitude) && isNaN(c.zoomLongitude) && (a.centerMap ? (c.zoomLatitude = a.coordinateToLatitude(a.mapHeight / 2), c.zoomLongitude = a.coordinateToLongitude(a.mapWidth / 2)) : (c.zoomX = 0, c.zoomY =
				0), a.zoomInstantly = !0);
	...
	animateMap: function() {
		var a = this;
		a.totalFrames =
			1E3 * a.zoomDuration / AmCharts.updateRate;
		a.totalFrames += 1;
		a.frame = 0;
		a.tweenPercent = 0;
		setTimeout(function() {
	...
	handleMouseMove: function(a) {
		...
		b.mouse2X = NaN;
		b.mouse2Y = NaN;
		a && a.touches && (a = a.touches.item(1)) && (b.mouse2X = a.pageX - AmCharts.findPosX(b.div),
			b.mouse2Y = a.pageY - AmCharts.findPosY(b.div));
		if(a = b.mapContainer) {
			var h = b.mouse2X,
				k = b.mouse2Y;
			...
			if(!isNaN(h)) {
				...
				var h = Math.sqrt(Math.pow(h - f, 2) + Math.pow(k - e, 2)),
					q = b.previousDistance,
					k = Math.max(b.realWidth, b.realHeight);
				5 > Math.abs(q - h) && (b.isDragging = !0);
				if(!isNaN(q)) {
					var x = 5 * Math.abs(q - h) / k,
						k = a.scale,
						k = AmCharts.fitToBounds(q < h ? k + k * x : k - k *
							x, g.minZoomLevel, g.maxZoomLevel),
						g = b.zoomLevel(),
						z = b.middleXP,
						q = b.middleYP,
						x = l / r,
						v = m / n,
						z = (b.zoomX() - z * v) * (k / g) + z * v,
						q = (b.zoomY() - q * x) * (k / g) + q * x;
					.1 < Math.abs(k - g) && (b.zoomTo(k, z, q, !0), b.mapWasPinched = !0, clearTimeout(b.pinchTO))
				}
				b.previousDistance = h
			}
			h = a.scale;
			b.isDragging && (b.hideBalloon(), b.positionChanged(), c = a.x + (f - c), d = a.y + (e - d), b.preventDragOut && (r = -r * h + l / 2, l /= 2, c = AmCharts.fitToBounds(c, -n * h + m / 2, m / 2), d = AmCharts.fitToBounds(d, r, l)), a.translate(c, d, h), b.updateSmallMap());
			b.previuosMouseX = f;
			b.previuosMouseY =
				e
		}
	...
	selectObject: function(a) {
		...
		if(c && !f && ("string" == typeof c && (c = b.getObjectById(c)),
		...
		!f && isNaN(a.zoomLevel) && isNaN(a.zoomX) && isNaN(a.zoomY) ? (b.showDescriptionAndGetUrl(), b.processObjects()) : (b.selectedObjectTimeOut = setTimeout(function() {
			...
			}, 1E3 * c + 200), b.showObjectsAfterZoom ? b.processObjectsTimeOut =
			setTimeout(function() {
		...
		if(f = a.displayObject) {
			...
			if(!a.preserveOriginalAttributes) {
				...
				var l = a.imageLabel;
				l && (c = a.selectedLabelColorReal, void 0 !== c && l.setAttr("fill",
					c))
			}
			a.selectable || (f.setAttr("cursor", "default"), l && l.setAttr("cursor", "default"))
		} else b.returnInitialColorReal(a);
		if(f = a.groupId)
			for(l = b.getGroupById(f), c = 0; c < l.length; c++)
				if(k = l[c], k.isOver = !1, f = k.displayObject)
					if(h = k.selectedColorReal, void 0 !== e && f.setAttr("stroke", e), void 0 !== h ? f.setAttr("fill", h) : b.returnInitialColor(k), "MapLine" == k.objectType && ((h = k.lineSvg) && h.setAttr("stroke", g), k = k.arrowSvg)) k.setAttr("fill", g), k.setAttr("stroke", g);
	...
	returnInitialColorReal: function(a) {
		...
		if(b) {
			...
			"MapArea" == a.objectType && (c = 1, this.areasSettings.adjustOutlineThickness && (c = this.zoomLevel()), b.setAttr("fill-opacity",
				a.alphaReal), b.setAttr("stroke-opacity", a.outlineAlphaReal), b.setAttr("stroke-width", a.outlineThicknessReal / c));
	...
	zoomToLatLongRectangle: function(a, b, c,
		d) {
	...
	zoomToGroup: function(a) {
		a =
			"object" == typeof a ? a : this.getGroupById(a);
		var b, c, d, f, e;
		for(e = 0; e < a.length; e++) {
	...
	rollOverMapObject: function(a, b, c) {
		if(this.chartCreated) {
			...
			if(!this.preventHover) {
				...
				else if((this.showBalloonOnSelectedObject || !this.checkIfSelected(a)) && !1 !== b && (f = this.balloon, b = a.colorReal, d = "", void 0 !== b && this.useObjectColorForBalloon ||
						(b = f.fillColor), (f = a.balloonTextReal) && (d = this.formatString(f, a)), this.balloonLabelFunction && (d = this.balloonLabelFunction(a, this)), d && "" !== d)) {
					var e, g;
	...
	longitudeToX: function(a) {
		return this.longitudeToCoordinate(a) *
			this.zoomLevel() + this.mapContainer.x
	},
	...
	formatString: function(a, b) {
		...
		void 0 == f && (f = "");
		var e = b.value,
			e = isNaN(e) ? "" : AmCharts.formatNumber(e,
				c),
			c = b.percents,
	...
	recalcLongitude: function(a) {
		...
		return void 0 != a && b ? a < this.dataProvider.leftLongitude ?
			Number(a) + 360 : a : a
	},
	...
	coordinateToLatitude: function(a) {
		...
		if(this.mapSet) {
			...
			"mercator" == c.projection ? (c = this.mercatorLatitudeToCoordinate(d), f = this.mercatorLatitudeToCoordinate(f), a = 2 * Math.atan(Math.exp(2 * (a * (c - f) / b + f) * Math.PI /
				180)) - .5 * Math.PI, b = AmCharts.radiansToDegrees(a)) : b = a / b * (d - f) + f
		}
	...
	processObject: function(a, b, c) {
		if(a) {
			...
			for(d = 0; d < a.length; d++) {
				...
				"line" ==
				c && (f = AmCharts.extend(f, new AmCharts.MapLine(this.theme), !0));
				a[d] = f;
...
AmCharts.ZoomControl = AmCharts.Class({
	...
	init: function(a, b) {
		...
		isNaN(c.bottom) || (t = a.getY(c.bottom, !0), e && (t -= x + 3 * f), t = g ? t - 3 * f : t + f);
		d.translate(w, t);
		c.previousDY = NaN;
		var u;
		if(e) {
			...
			c.set = d;
			c.zoomSet = u;
			t = AmCharts.rect(b, f + 6, x + 2 * f + 6, c.gridBackgroundColor, c.gridBackgroundAlpha, 0, 0, 0, 4);
			AmCharts.setCN(a, t, "zoom-bg");
			t.translate(-3, -3);
			t.mouseup(function() {
				c.handleBgUp()
			}).touchend(function() {
			...
			t.init(b, f, f, h, k, l, m, n, r, q, A);
			AmCharts.setCN(a, t.set, "zoom-in");
			u.push(t.set);
			t = new AmCharts.SimpleButton;
			t.setIcon(a.pathToImages + "minus.gif", c.iconSize);
			t.setClickHandler(a.zoomOut, a);
			t.init(b, f, f, h, k, l, m, n, r, q, A);
			t.set.translate(0, x + f);
			AmCharts.setCN(a, t.set, "zoom-out");
			u.push(t.set);
			var w = Math.log(B / v) /
				Math.log(z) + 1,
				e = x / w,
				p;
			for(p = 1; p < w; p++) t = f + p * e, t = AmCharts.line(b, [1, f - 2], [t, t], c.gridColor, c.gridAlpha, 1), AmCharts.setCN(a, t, "zoom-grid"), u.push(t);
			t = new AmCharts.SimpleButton;
			t.setDownHandler(c.draggerDown, c);
			t.setClickHandler(c.draggerUp, c);
			t.init(b, f, e, h, k, l, m, n, r, q);
			AmCharts.setCN(a, t.set, "zoom-dragger");
			u.push(t.set);
			c.dragger = t.set;
			c.previousY = NaN;
			x -= e;
			v = Math.log(v / 100) / Math.log(z);
			z = Math.log(B / 100) / Math.log(z);
			c.realStepSize = x / (z - v);
			c.realGridHeight = x;
			c.stepMax = z
		}
		g && (g = b.set(), AmCharts.setCN(a,
				g, "zoom-control-pan"), d.push(g), u && u.translate(f, 4 * f), u = new AmCharts.SimpleButton, u.setIcon(a.pathToImages + "panLeft.gif", c.iconSize), u.setClickHandler(a.moveLeft, a), u.init(b, f, f, h, k, l, m, n, r, q, A), u.set.translate(0, f), AmCharts.setCN(a, u.set, "pan-left"), g.push(u.set), u = new AmCharts.SimpleButton, u.setIcon(a.pathToImages + "panRight.gif", c.iconSize), u.setClickHandler(a.moveRight, a), u.init(b, f, f, h, k, l, m, n, r, q, A), u.set.translate(2 * f, f), AmCharts.setCN(a, u.set, "pan-right"), g.push(u.set), u = new AmCharts.SimpleButton,
			u.setIcon(a.pathToImages + "panUp.gif", c.iconSize), u.setClickHandler(a.moveUp, a), u.init(b, f, f, h, k, l, m, n, r, q, A), u.set.translate(f, 0), AmCharts.setCN(a, u.set, "pan-up"), g.push(u.set), u = new AmCharts.SimpleButton, u.setIcon(a.pathToImages + "panDown.gif", c.iconSize), u.setClickHandler(a.moveDown, a), u.init(b, f, f, h, k, l, m, n, r, q, A), u.set.translate(f, 2 * f), AmCharts.setCN(a, u.set, "pan-down"), g.push(u.set), k = new AmCharts.SimpleButton, k.setIcon(a.pathToImages + c.homeIconFile, c.iconSize), k.setClickHandler(a.goHome, a), k.init(b,
				f, f, h, 0, 0, m, 0, r, q, A), k.set.translate(f, f), AmCharts.setCN(a, k.set, "pan-home"), g.push(k.set), d.push(g))
	},
...
AmCharts.SmallMap = AmCharts.Class({
	...
	init: function(a, b) {
		...
		AmCharts.setCN(a, m.set, "small-map-down");
		m = m.set;
		c.downButtonSet = m;
		d.push(m);
		...
		d.push(g);
		var r, q;
		isNaN(c.top) || (k = a.getY(c.top) + e, q = 0);
		isNaN(c.bottom) || (k = a.getY(c.bottom, !0) - c.height - e, q = c.height - h + e / 2);
		isNaN(c.left) || (l = a.getX(c.left) + e, r = -e / 2);
		isNaN(c.right) || (l = a.getX(c.right, !0) - c.width - e, r = c.width - h + e / 2);
		e = b.set();
		e.clipRect(1, 1, c.width,
			c.height);
		f.push(e);
		c.rectangleC = e;
		d.translate(l, k);
	...
	handleMouseUp: function() {
		var a = this.chart,
			b = a.zoomLevel();
		a.zoomTo(b, -((a.mouseX - this.set.x - this.dx - this.rWidth / 2) / this.mapWidth) * b, -((a.mouseY - this.set.y - this.dy -
			this.rHeight / 2) / this.mapHeight) * b)
	}
});
	...
	process: function(a) {
		...
		for(f =
			...
			var n = c.color,
				...
				t = c.selectable,
				u = c.pattern,
				p = c.rollOverOutlineColor,
				y = c.bringForwardOnHover,
				C = c.preserveOriginalAttributes;
			this.allObjects.push(e);
			e.chart = b;
			e.baseSettings = c;
			e.autoZoomReal = void 0 == e.autoZoom ?
				c.autoZoom : e.autoZoom;
			g = e.color;
			void 0 == g && (g = n);
			var F = e.alpha;
			isNaN(F) && (F = r);
			...
			isNaN(A) && (A = q);
			q = e.rollOverOutlineColor;
			void 0 == q && (q = p);
			void 0 == e.bringForwardOnHover && (e.bringForwardOnHover = y);
			void 0 == e.preserveOriginalAttributes && (e.preserveOriginalAttributes = C);
			e.alphaReal = F;
			e.rollOverColorReal = v;
			e.rollOverAlphaReal = r;
			e.balloonTextReal = z;
			e.selectedColorReal = u;
			e.outlineColorReal = n;
			e.outlineAlphaReal = B;
			e.rollOverOutlineColorReal =
				q;
			e.outlineThicknessReal = A;
			e.patternReal = x;
			AmCharts.processDescriptionWindow(c, e);
			if(m && (c = m.area, p = m.title, e.enTitle = m.title, p && !e.title && (e.title = p), (m = b.language) ? (p = AmCharts.mapTranslations) && (m = p[m]) && m[e.enTitle] && (e.titleTr = m[e.enTitle]) : e.titleTr = void 0, c)) {
				e.displayObject = c;
				...
				e.preserveOriginalAttributes || (c.setAttr("fill", D), c.setAttr("stroke", n), c.setAttr("stroke-opacity", B), c.setAttr("stroke-width", A), c.setAttr("fill-opacity", F));
				x && c.pattern(x, b.mapScale);
				e.hidden && c.hide()
			}
		}
	},
	updateAllAreas: function() {
		...
		for(m =
			...
			if(b.preserveOriginalAttributes) {
				if(k.customAttr)
					for(var n in k.customAttr) k.setAttr(n, k.customAttr[n])
			...
			if(h.getAreasFromMap && !l[k.id]) {
				var r = new AmCharts.MapArea(a.theme);
				r.parentObject = h;
				r.id = k.id;
				h.areas.push(r)
			}
...
AmCharts.ImagesProcessor = AmCharts.Class({
	...
	createImage: function(a, b) {
		...
		v = a.height;
		g = a.scale;
		isNaN(a.percentWidth) || (q = a.percentWidth / 100 * c.realWidth);
		isNaN(a.percentHeight) || (v = a.percentHeight / 100 * c.realHeight);
		var C;
		t || u || B || (u = "circle", q = 1, k = h = 0);
		l = z = 0;
		A = a.selectedColorReal;
		if(u) {
			isNaN(q) && (q = 10);
			isNaN(v) && (v = 10);
			"kilometers" == a.widthAndHeightUnits && (q = c.kilometersToPixels(a.width), v = c.kilometersToPixels(a.height));
			"miles" == a.widthAndHeightUnits && (q = c.milesToPixels(a.width), v = c.milesToPixels(a.height));
			if("circle" == u || "bubble" == u) v = q;
			C = this.createPredefinedImage(y, n, r, u, q, v);
			l = z = 0;
			a.centeredReal ? (isNaN(a.right) || (z = q * g), isNaN(a.bottom) || (l = v * g)) : (z = q * g / 2, l = v * g / 2);
			C.translate(z, l, g)
		} else t ? (isNaN(q) && (q = 10), isNaN(v) && (v = 10), C = d.image(t, 0, 0, q, v), C.node.setAttribute("preserveAspectRatio", "none"), C.setAttr("opacity", h), a.centeredReal && (z = isNaN(a.right) ? -q / 2 : q / 2, l = isNaN(a.bottom) ? -v / 2 : v / 2, C.translate(z, l))) : B && (C =
			d.path(B), n = C.getBBox(), a.centeredReal ? (z = -n.x * g - n.width * g / 2, isNaN(a.right) || (z = -z), l = -n.y * g - n.height * g / 2, isNaN(a.bottom) || (l = -l)) : z = l = 0, C.translate(z, l, g), C.x = z, C.y = l);
		C && (p.push(C), a.image = C, C.setAttr("stroke-opacity", k), C.setAttr("fill-opacity", h), C.setAttr("fill", y), AmCharts.setCN(c, C, "map-image"), void 0 != a.id && AmCharts.setCN(c, C, "map-image-" + a.id));
		!a.showAsSelected && c.selectedObject != a || void 0 == A || C.setAttr("fill", A);
		y = null;
		void 0 !== a.label && (y = AmCharts.text(d, a.label, a.labelColorReal, c.fontFamily,
			a.labelFontSizeReal, a.labelAlign), AmCharts.setCN(c, y, "map-image-label"), void 0 !== a.id && AmCharts.setCN(c, y, "map-image-label-" + a.id), C = a.labelBackgroundAlpha, (h = a.labelBackgroundColor) && 0 < C && (k = y.getBBox(), d = AmCharts.rect(d, k.width + 16, k.height + 10, h, C), AmCharts.setCN(c, d, "map-image-label-background"), void 0 != a.id && AmCharts.setCN(c, d, "map-image-label-background-" + a.id), p.push(d), a.labelBG = d), a.imageLabel = y, p.push(y), AmCharts.setCN(c, p, "map-image-container"), void 0 != a.id && AmCharts.setCN(c, p, "map-image-container-" +
			a.id));
		isNaN(a.latitude) || isNaN(a.longitude) ? e.push(p) : f.push(p);
...
AmCharts.LinesProcessor = AmCharts.Class({
	...
	process: function(a) {
		...
		for(u = 0; u < b.length; u++) {
			...
			p.mouseEnabled && c.addObjectEventListeners(y, p);
			if(p.remainVisible || c.selectedObject == p.parentObject) {
				...
				var E = p.alpha;
				isNaN(E) && (E = x);
				var G = p.rollOverAlpha;
				isNaN(G) && (G = B);
				isNaN(G) && (G = E);
				var I = p.rollOverColor;
				void 0 == I && (I = z);
				var T = p.selectedColor;
				void 0 == T && (T = v);
				var R = p.balloonText;
				R || (R = A);
				var L = p.arrow;
				...
				p.rollOverAlphaReal = G;
				p.balloonTextReal = R;
				p.selectedColorReal = T;
				p.thicknessReal = C;
				void 0 == p.bringForwardOnHover && (p.bringForwardOnHover = w);
				AmCharts.processDescriptionWindow(d, p);
				var G = this.processCoordinates(p.x, c.realWidth),
					I = this.processCoordinates(p.y, c.realHeight),
					K = p.longitudes,
					R = p.latitudes,
					J =
					K.length,
					P;
				if(0 < J)
					for(G = [], P = 0; P < J; P++) G.push(c.longitudeToCoordinate(K[P]));
				J = R.length;
				if(0 < J)
					for(I = [], P = 0; P < J; P++) I.push(c.latitudeToCoordinate(R[P]));
				if(0 < G.length) {
					AmCharts.dx = 0;
					AmCharts.dy = 0;
					K = AmCharts.line(t, G, I, D, 1, C, F, !1, !1, !0);
					AmCharts.setCN(c, K, "map-line");
					void 0 != p.id && AmCharts.setCN(c, K, "map-line-" + p.id);
					F = AmCharts.line(t, G, I, D, .001, 3, F, !1, !1, !0);
					AmCharts.dx = .5;
					AmCharts.dy = .5;
					y.push(K);
					y.push(F);
					...
					if("none" != L) {
						var H, Q, S;
						if("end" == L || "both" == L) E = G[G.length - 1], D = I[I.length -
							1], 1 < G.length ? (J = G[G.length - 2], H = I[I.length - 2]) : (J = E, H = D), H = 180 * Math.atan((D - H) / (E - J)) / Math.PI, Q = E, S = D, H = 0 > E - J ? H - 90 : H + 90;
						"both" == L && (E = AmCharts.polygon(t, [-M / 2, 0, M / 2], [1.5 * M, 0, 1.5 * M], N, O, 1, N, O), y.push(E), E.translate(Q, S), E.rotate(H), AmCharts.setCN(c, K, "map-line-arrow"), void 0 != p.id && AmCharts.setCN(c, K, "map-line-arrow-" + p.id), p.fixedSize && f.push(E));
						if("start" == L || "both" == L) E = G[0], S = I[0], 1 < G.length ? (D = G[1], Q = I[1]) : (D = E, Q = S), H = 180 * Math.atan((S - Q) / (E - D)) / Math.PI, Q = E, H = 0 > E - D ? H - 90 : H + 90;
						"middle" == L && (E =
							G[G.length - 1], D = I[I.length - 1], 1 < G.length ? (J = G[G.length - 2], H = I[I.length - 2]) : (J = E, H = D), Q = J + (E - J) / 2, S = H + (D - H) / 2, H = 180 * Math.atan((D - H) / (E - J)) / Math.PI, H = 0 > E - J ? H - 90 : H + 90);
						E = AmCharts.polygon(t, [-M / 2, 0, M / 2], [1.5 * M, 0, 1.5 * M], N, O, 1, N, O);
						AmCharts.setCN(c, K, "map-line-arrow");
						void 0 != p.id && AmCharts.setCN(c, K, "map-line-arrow-" + p.id);
						y.push(E);
						E.translate(Q, S);
						E.rotate(H);
						p.fixedSize && f.push(E);
						p.arrowSvg = E
					}
					...
					p.lineSvg = K;
					p.showAsSelected && !isNaN(T) && K.setAttr("stroke", T);
					0 < R.length ? e.push(y) : g.push(y);
					p.hidden && y.hide()
				}
			}
		}
...
AmCharts.ValueLegend = AmCharts.Class({
	...
	init: function(a, b) {
		...
		var e = b.set();
		this.set = e;
		AmCharts.setCN(a, e, "value-legend");
		var g =
			0,
			h = this.minValue,
			k = this.fontSize,
		...
		if(this.showAsGradient) c = AmCharts.rect(b, this.width, this.height, [c, d], 1, this.borderThickness, this.borderColor, 1, 0, 0), AmCharts.setCN(a, c, "value-legend-gradient"), c.translate(0, g), e.push(c);
		else
			for(k = this.width / f, l = 0; l < f; l++) m = AmCharts.getColorFade(c, d, 1 * l / (f - 1)), m = AmCharts.rect(b, k, this.height, m, 1, this.borderThickness, this.borderColor, 1), AmCharts.setCN(a, m, "value-legend-color"), AmCharts.setCN(a, m, "value-legend-color-" + l), m.translate(k * l, g), e.push(m);
		d = c = 0;
		f = e.getBBox();
